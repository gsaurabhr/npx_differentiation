...
def spectral_states(
    sample_rate, window_length, data, average_spectra=False, norm=None, axes=(-1,)
):
    ...
    spectra = np.fft.rfftn(data, axes=axes, norm=norm)
...
def spectral_differentiation(
    ...
    axes=(-1,), sample_rate=50, sqrt=False, norm=None
):
